...
This repository is built in PyTorch 2.0.0 and tested on Ubuntu 18.04 environment (Python3.9.17, CUDA11.7).
...
The Conda environment used can be recreated using the requirements.txt file
